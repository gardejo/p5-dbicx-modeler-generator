...
Test::DBICx::Modeler::Generator::Manual::SQLite - Tests for manually using DBICx::Modeler::Generator::Driver::SQLite
...
manually using L<DBICx::Modeler::Generator::Driver::SQLite>.
